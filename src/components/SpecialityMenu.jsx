...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Chercher par spécialité</h1>
            <p className='sm:w-1/3 text-center text-sm'>Parcourez simplement notre vaste liste de médecins de confiance et planifiez votre rendez-vous sans tracas.</p>
